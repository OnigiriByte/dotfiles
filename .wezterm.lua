...
config.keys = {
        ...
        { key = 'w', mods = 'LEADER', action = action.ActivateKeyTable { name = 'window_menu', one_shot = true } },
...
config.key_tables = {
        ...
        window_menu = {
                ...
                { key = '[', mods = 'CTRL',         action = 'PopKeyTable' },
                { key = 'r', action = action.ActivateKeyTable {name = 'resize_pane', one_shot = false}},
                { key = 'f', action = action.ActivateKeyTable {name = 'focus_pane', one_shot = false}},
